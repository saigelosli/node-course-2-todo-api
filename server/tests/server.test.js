...
// Empty the database before each request
...
describe( 'PATCH /todos/:id', () => {
  ...
  it( 'should clear completedAt when todo is not completed', (done) => {
    ...
    var newText = "Text is now MORE updated than it was before";
...
describe( 'POST /users', () => {
  ...
  // Test invalid email
  it( 'should return validation errors if e-mail address invalid', (done) => {

    request(app)
      .post( '/users' )
      .send( { email: 'bad-email-address', password } )
      .expect( 400 )
      .end( done );
    });
